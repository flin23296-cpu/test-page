...
function generateShareImage() {
  ...
  setTimeout(() => {
    ...
    contentHeight += 70; // 关键词
    const dLen = estimateTextHeight(userResult.description, '28px "PingFang SC", "Microsoft YaHei", sans-serif', 600);
    contentHeight += dLen;
    contentHeight += 50;
    ...
    const canvasHeight = Math.max(contentHeight, 1020);
